...
const Footer: React.FC<FooterProps> = () => {
  return (
    <div className=" ">
      <div className="grid grid-cols-4 bg-[#eeeffb] w-full gap-8 h-[479px]">
        <div className="w-[1177px] flex flex-row items-center justify-between">
          <div className="col-span-1">
            ...
            <p className="text-gray-750">
              ...
              />
              <button className="bg-pink-500 hover:bg-pink-800 text-white px-4 py-2 rounded ml-2">
                Sign Up
              </button>
            </p>
      ...
      <div className="text-center h-[53px] w-full bg-[#e7e4f8]">
